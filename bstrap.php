...
<html lang="en">
  ...
  <body class="text-center">
    ...
    <input class="form-control mr-sm-2" type="search" placeholder="Search Buses" aria-label="Search">
    <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
      ...
      <main role="main" class="inner cover">
        ...
        <p class="lead">Bus Transportation System.</p>
        <p class="lead">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter ID (2015cse159)" name="id">
  ...
  <button type="submit" class="btn btn-primary">Submit</button>
      ...
      <footer class="mastfoot mt-auto">
        <div class="inner">
          <p>Admin Login <a href="#">Click Here</a>.</p>
        </div>
      </footer>
    </div>
